...
* 1° Consulta: <br>
`SELECT EXAME_PACIENTE.CD_EXAME_PACIENTE, PESSOA.NM_PESSOA AS NOME, EXAME.TIPO_EXAME, EXAME_PACIENTE.CRM_MEDICO, EXAME_PACIENTE.DT_EXAME`<br>
`FROM EXAME_PACIENTE`<br>
`INNER JOIN PESSOA`<br>
`ON(EXAME_PACIENTE.ID_PESSOA = PESSOA.ID_PESSOA)`<br>
`INNER JOIN EXAME`<br>
