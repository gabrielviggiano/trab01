...
* 4° Consulta <br>
```
SELECT ID_PESSOA, CD_ESPECIALIDADE, CRM_MEDICO FROM MEDICO
WHERE ID_PESSOA > 15
GROUP BY ID_PESSOA, CD_ESPECIALIDADE, CRM_MEDICO
```
* 5° Consulta <br>
```
...
* 6° Consulta <br>
```
SELECT ID_PESSOA, ID_TIPO, NM_CONTATO FROM CONTATO
WHERE ID_TIPO = 103
GROUP BY ID_PESSOA, ID_TIPO, NM_CONTATO
```
